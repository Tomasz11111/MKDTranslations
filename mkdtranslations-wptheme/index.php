...
<div class="homepage-hero-module">
    <div class="video-container">
        ...
        <video autoplay loop class="fillWidth hidden-xs hidden-sm">
            <source src="White-Keyboard/MP4/White-Keyboard.mp4" type="video/mp4" />Your browser does not support the video tag. I suggest you upgrade your browser.
            <source src="White-Keyboard/WEBM/White-Keyboard.webm" type="video/webm" />Your browser does not support the video tag. I suggest you upgrade your browser.
        </video>
        <div class="poster hidden-md hidden-lg hidden-xl">
            <img src="White-Keyboard/Snapshots/White-Keyboard.jpg" alt="">
        </div>
    </div>
</div>
<div class="container-fluid bg-about" id="about">
    <div class="row">
        <div class="col-lg-5 col-xs-12 about-left">
            <p class="about-title"><span class="hidden-sm hidden-xs">ABOUT</span></p>
            <p class="about-mobile hidden-md hidden-lg hidden-xl"><span>ABOUT</span> ME</p>
        </div>
        <div class="col-lg-7 col-xs-12 about-right">
            <p class="about-title-right hidden-sm hidden-xs"> ME</p>
            <p class="about-main slideanim"> I am a translator and teacher with more than 6 years' experience in the field. I have a MA in applied translation from Warsaw University. I perform excellent translations from <span>English</span>, <span>French</span> and <span>Czech</span></p>
        <p class="about-secondary slideanim">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
...
<div class="container-fluid bg-grey" id="services">
    <div class="row-col">
        <div class="col-lg-12 col-xs-12"><h1 class ="section-title">My solutions and services</h1>
            <p class="section-title-lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
        </div>
    </div>
</div>
<div class="container-fluid bg-grey" id="services_content">
    <div class="row row-icons">
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-teal"><img src="icons/translation-green.png" class="icon-set-width"></div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-teal"><img src="icons/revision-green.jpg" class="icon-set-height"></div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-teal"><img src="icons/software-green.jpg" class="icon-set-width"></div>
            <div class="icon_title"><h4 class="icon-headline icon-headline-animation">Linguistic software testing</h4></div>
            <div class="icon_description"><p class="icon-description-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p></div>
        </div>
         
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-teal"><img src="icons/glossary-green.png" class="icon-set-height"></div>
            <div class="icon_title"><h4 class="icon-headline icon-headline-animation">Style guide and glossary creation</h4></div>
            <div class="icon_description"><p class="icon-description-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p></div>
        </div>
        
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-teal"><img src="icons/teaching-green.jpg" class="icon-set-width"></div>
            <div class="icon_title"><h4 class="icon-headline icon-headline-animation">Language teaching</h4></div>
            <div class="icon_description"><p class="icon-description-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p></div>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-teal"><img src="icons/consultancy-green.jpg" class="icon-set-height"></div>
...
<div class="container-fluid" id="translation">
    <div class="row-col">
        <div class="col-lg-12 col-xs-12"><h1 class="section-title">Translation</h1>
            <p class="section-title-lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
        </div>
    </div>
</div>
...
<div class="col-lg-12 morespecialties">
	...
	<button class="btn-standard btn-teal"><a>Other frequently translated texts</a></button>
        </div>
    </div>
 </div>
 ...
 <div class="container-fluid bg-grey" id="process">
    <div class="row-col">
        <div class="col-lg-12 col-xs-12"><h1 class="section-title">Translation process</h1>
            <p class="section-title-lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
        </div>
    </div>
</div>
<div class="container-fluid bg-grey padding" id="process-content">
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="icon-circle icon-circle-teal"><img src="icons/trophy-green.jpg" class="icon-set-width"></div>
            ...
            <ul class="high_standards_and_guidelines_list">
                <li><img src="icons/check-green.png" class="check_full hidden"><img src="icons/check-green-empty.png" class="check_empty">I provide professional advice and assistance to clients in determining their translation needs;</li>

                <li><img src="icons/check-green.png" class="check_full hidden"><img src="icons/check-green-empty.png" class="check_empty">I meet specified deadlines (within reasonable limits);</li>

                <li><img src="icons/check-green.png" class="check_full hidden"><img src="icons/check-green-empty.png" class="check_empty">I advise the client in a timely manner when deadlines cannot be met and negotiates new terms;</li>

                <li><img src="icons/check-green.png" class="check_full hidden"><img src="icons/check-green-empty.png" class="check_empty">I use consistent terminology in all translations (efficient use of CAT tools and glossaries);</li>

                <li><img src="icons/check-green.png" class="check_full hidden"><img src="icons/check-green-empty.png" class="check_empty">I coordinate services if documents require translation into a language other than Polish or proofreading.</li>
            </ul>
        </div>
        <div class="col-lg-4"><div class="icon-circle icon-circle-teal"><img src="icons/guidelines-green.jpg" class="icon-set-height"></div>
            
            <div class="icon_title"><h4 class="icon-headline icon-headline-animation">Guidelines</h4></div>
            <ul class="high_standards_and_guidelines_list">
                <li><img src="icons/check-green.png" class="check_full hidden"><img src="icons/check-green-empty.png" class="check_empty">To ensure a satisfactory level of service, MKD Translations prefers that all documents for translation be provided electronically.</li>
                <li><img src="icons/check-green.png" class="hidden check_full"><img src="icons/check-green-empty.png" class="check_empty">However, mailed or couriered documents are accepted.</li>
                <li><img src="icons/check-green.png" class="hidden check_full"><img src="icons/check-green-empty.png" class="check_empty">It is difficult for MKD Translations to provide translation of isolated words as meaning depends on context. In order to translate independent terms accurately, MKD Translations requires background information.</li>
            </ul>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-green"><p class="confidentiality slideanim">MKD Translations considers all texts confidential and undertakes not to disclose any facts learned in relation to our activities.</p></div>
    </div>
    </div>
    <div class="container-fluid" id="teaching">
    <div class="row-col">
        <div class="col-lg-12 col-xs-12"><h1 class="section-title">Teaching</h1>
            <p class="section-title-lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
        </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="outer_border">
            <div class="inner_border"><p>Learn French</p></div>
            </div>
        </div>
        </div>
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 polish">
            <div class="outer_bg">
        <div class="outer_border">
            <div class="inner_border"><p>Learn Polish</p></div>
            </div></div>
    </div>
</div>
    </div>
...
<div class="container-fluid bg-grey" id="how_i_teach">
    <div class="row-col">
        <div class="col-lg-12 col-xs-12"><h1 class="section-title">How I teach</h1>
            <p class="section-title-lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
        </div>
    </div>
</div>
<div class="container-fluid bg-grey" id="how_i_teach_icons">
    <div class="row row-icons">
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-purple"><img src="icons/location-purple.jpg" class="icon-set-width"></div>
            <div class="icon_title"><h4 class="icon-headline icon-headline-animation">Convenient location</h4></div>
            <div class="description"><p class="icon-description-text">The courses take place in the Vinohrady district of Prague, 200 m from the Square of George of Poděbrady (Metro Line A - Station Jiřího z Poděbrad)</p></div>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-purple"><img src="icons/individual_group-purple.png" class="icon-set-width"></div>
            <div class="icon_title"><h4 class="icon-headline icon-headline-animation">Individual or group courses</h4></div>
            <div class="description"><p class="icon-description-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p></div>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-purple"><img src="icons/onlinecourses-purple.jpg" class="icon-set-height"></div>
            <div class="icon_title"><h4 class="icon-headline icon-headline-animation">Online classes</h4></div>
            <div class="icon_description"><p class="icon-description-text">Additionally, it is possible to agree on online courses - via CliqMeet or Skype.</p></div>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-purple"><img src="icons/onlinetools-purple.jpg" class="icon-set-height"></div>
            <div class="icon_title"><h4 class="icon-headline icon-headline-animation">Online tools</h4></div>
            <div class="icon_description"><p class="icon-description-text">I use online learning platforms such as Moodle</p></div>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-purple"><img src="icons/progress-purple.png" class="icon-set-width"></div>
            <div class="icon_title"><h4 class="icon-headline icon-headline-animation">Regular progress assessment</h4></div>
            <div class="description"><p class="icon-description-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p></div>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="icon-circle icon-circle-purple"><img src="icons/coursebooks-purple.jpg" class="icon-set-height"></div>
            <div class="icon_title"><h4 class="icon-headline icon-headline-animation">Various coursebooks</h4></div>
            <div class="icon_description"><p class="icon-description-text">I use variety of coursebooks. Choose the one that suits you best</p></div>

        </div>
		 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pricing-buttons">
			<button class="btn-standard btn-how-i-teach" id="btn-pricing"><span>Pricing</span></button>
            <button class="btn-standard btn-how-i-teach"><a href="termsandconditions.html">Terms &amp; conditions</a></button>
        </div>
