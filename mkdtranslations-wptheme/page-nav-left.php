...
<div class="container-fluid" id="terms_title">
            <div class="row">
    <div class="col-lg-12 col-xs-12 subpage-header subpage-header-translation"><p class="section_title"><span>Translation services</span></p>
...
<div class='container-fluid bg-grey padding' id='process-content'>
    <div class='row'>
        ...
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 pricing-buttons'>
            ...
            <button class='btn-standard btn-teal'><a href='<?php echo get_permalink(5);?>'><?php $value = get_field ('process_button_right');
				if ($value) {
					echo $value;
				}
				else {
