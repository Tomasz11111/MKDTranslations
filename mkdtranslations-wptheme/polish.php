...
<div class='container' id='learn-polish-pricing'>
	<div class='row'>
		...
		<div class='col-lg-12'>
			<p class='learn-pricing-section'>Polish lessons in my appartment or via Skype</p></div>
		<div class='col-lg-4'>
			<h3>Slow-paced</h3>
		...
		<div class='col-lg-12'><p class='learn-pricing-section'>Polish lessons in your company/home/cafe in Prague</p></div>
		<div class='col-lg-4'>
			<h3>Slow-paced</h3>
			<table>
				<col>
